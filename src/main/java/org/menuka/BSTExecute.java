...
public class BSTExecute {
    ...
    private static void set(String set) {
        ...
        for (int j = 1; j <= 3; j++) {
            String currentSet = set;
            // insert
            BSTinsert(st1, currentSet, Integer.toString(j));

            // search
            BSTsearch(st1, currentSet, Integer.toString(j));

            // delete
            BSTdelete(st1, currentSet, Integer.toString(j));
        }
    }
